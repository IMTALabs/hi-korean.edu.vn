                ...
                <div class="lg:col-span-1">
                    <div class="flex grow flex-col items-start justify-center">
                        ...
                        <ol class="mt-8 marker:text-3xl marker:font-bold">
                            <li>Các doanh nghiệp có yếu tố Hàn Quốc</li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col col-lg-5">
                        <div class="section_heading">
                            <h3 class="text-2xl !text-secondary">Đào tạo doanh nghiệp</h3>
                                        ...
                                        <div id="collapse_one" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                <ul class="space-y-4 pl-4">
                                                    <li>Tùy theo đặc điểm của doanh nghiệp có thể lựa chọn khóa "Giao
                                                        tiếp", hoặc khóa "Luyện thi Topik"
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div class="accordion space-y-8" id="faq_accordion_2">
                                    <div class="accordion-item bg-[#F8F2E6] px-8 py-4 rounded-xl">
                                        <div id="collapse_two" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                <ul class="space-y-4 pl-4">
                                                    <li>Đội ngũ giáo viên giỏi, thường xuyên được training nâng cao kỹ
                                                        năng
                                                    </li>
                                                    <li>Giáo trình học chính thống, tùy chỉnh theo nhu cầu doanh
                                                        nghiệp
                                                    </li>
                                                    <li>Phương pháp học hiệu quả, kết hợp nhiều chương trình học sinh
                                                        động
                                                    </li>
                                                    <li>Có kinh nghiệm triển khai đào tạo tại các doanh nghiệp lớn ở
                                                        Việt Nam
                                                    </li>
                                                </ul>
                                            </div>
