                ...
                <div class="lg:col-span-1">
                    <div class="flex grow flex-col items-start justify-center">
                        ...
                        <ol class="mt-8 marker:text-3xl marker:font-bold">
                            <li>Tất cả khách hàng có nhu cầu học nhưng cần linh hoạt về thời gian và địa điểm học</li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col col-lg-5">
                        <div class="section_heading">
                            <h3 class="text-2xl !text-secondary">E-learning</h3>
                                        ...
                                        <div id="collapse_one" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                <ul class="space-y-4 pl-4">
                                                    <li class="font-bold">Sơ cấp 1 (14 bài)</li>
                                                    <li class="font-bold">Sơ cấp 2 (10 bài)</li>
                                                    <li class="font-bold">Sơ cấp 3 (10 bài)</li>
                                                    <li class="font-bold">Sơ cấp 4 (10 bài)</li>
                                                    <li class="font-bold">Trung cấp 1</li>
                                                    <li class="font-bold">Trung cấp 2</li>
                                                    <li class="font-bold">Topik 3-4</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion space-y-8" id="faq_accordion_2">
                                    <div class="accordion-item bg-[#F8F2E6] px-8 py-4 rounded-xl">
                                        <div id="collapse_two" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                <ul class="space-y-4 pl-4">
                                                    <li>Phương pháp học hiệu quả</li>
                                                    <li>Kết hợp lớp học online</li>
                                                    <li>Nhiều bài tập</li>
                                                </ul>
                                            </div>
                                        </div>
