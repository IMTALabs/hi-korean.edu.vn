                ...
                <div class="lg:col-span-1">
                    <div class="flex grow flex-col items-start justify-center">
                        ...
                        <ol class="mt-8 marker:text-3xl marker:font-bold">
                            <li>Khả năng phân tích đề nhanh chóng.</li>
                            <li>Kiểm soát thời gian làm bài.</li>
                            <li>Củng cố và trau dồi từ vựng thông qua các đề thi thật các năm.</li>
                            <li>Nắm được các típ làm bài đúng trọng tâm.</li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col col-lg-5">
                        <div class="section_heading">
                            <h3 class="text-2xl !text-secondary">Topik 1-2</h3>
                                        ...
                                        <div id="collapse_one" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                <ul class="space-y-4 pl-4">
                                                    <li>20 buổi luyện và chữa đề.</li>
                                                    <li>Nắm rõ dạng bài và phương pháp làm bài tối ưu thời gian - đúng trọng tâm</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
