                ...
                <div class="lg:col-span-1">
                    <div class="flex grow flex-col items-start justify-center">
                        ...
                        <ol class="mt-8 marker:text-3xl marker:font-bold">
                            <li>Sinh viên, người đi làm có nhu cầu theo ngành biên phiên dịch</li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col col-lg-5">
                        <div class="section_heading">
                            <h3 class="text-2xl !text-secondary">Biên phiên dịch</h3>
                                        ...
                                        <div id="collapse_one" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                <ul class="space-y-4 pl-4">
                                                    ...
                                                    <li class="font-bold">Trung cấp 2 (30 buổi)</li>
                                                    <li class="font-bold">Topik 3-4 (48 buổi)</li>
                                                    <li class="font-bold">Biên phiên dịch Trung Cấp</li>
                                                    <li class="font-bold">Topik 5-6 (42 buổi)</li>
                                                    <li class="font-bold">
                                                        Biên phiên dịch Cao Cấp (12 buổi, 2 giờ/buổi)
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div class="accordion space-y-8" id="faq_accordion_2">
                                    <div class="accordion-item bg-[#F8F2E6] px-8 py-4 rounded-xl">
                                        <div id="collapse_two" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                <ul class="space-y-4 pl-4">
                                                    <li>100% giáo viên có trình độ Topik 5-6, xuất thân từ các trường
                                                        đại học có tiếng về chuyên ngành tiếng Hàn.
                                                    </li>
                                                    <li>Giáo trình của trường đại học top 3 Hàn Quốc mạnh về kỹ năng
                                                        nghe, nói. Ngoài ra các PPT được chuẩn bị riêng có xen kẽ các
                                                        bài đọc, viết bổ trợ.
                                                    </li>
                                                    ...
                                                    <li>Miễn phí dự các buổi hội thảo chia sẻ cách học, định hướng nghề
                                                        nghiệp, việc làm, giới thiệu văn hóa Hàn Quốc
                                                    </li>
