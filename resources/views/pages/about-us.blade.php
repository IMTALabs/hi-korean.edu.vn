...
<x-layouts.app>
    ...
    <main class="page_content">
        ...
        <div class="container mx-auto">
            <div class="row">
                <div class="col col-lg-6">
                    <img src="{{ asset('assets/images/about/image 110.png') }}" alt="" class="w-full -mt-48">
        ...
        <!-- Giảng viên - Start
        ================================================== -->
        <section class="expect_from_course section_space_lg bg-[#F8F2E6] mt-16">
            <div class="container">
                <div class="row">
        ...
        <section class="container bg-white shadow-2xl rounded-2xl -mt-28">
            <div class="flex flex-nowrap items-center">
                ...
                <div class="col col-lg-3 col-md-6">
                    <div class="counter_item border-0 p-4">
                        <div class="w-20 h-20 rounded-full bg-[#FDD561] flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24"><path fill="currentColor" d="M4 11.333L0 9l12-7l12 7v8.5h-2v-7.333l-2 1.166v6.678l-.223.275A9.983 9.983 0 0 1 12 22a9.983 9.983 0 0 1-7.777-3.714L4 18.011v-6.678ZM6 12.5v4.792A7.979 7.979 0 0 0 12 20a7.978 7.978 0 0 0 6-2.708V12.5L12 16l-6-3.5ZM3.97 9L12 13.685L20.03 9L12 4.315L3.97 9Z"/></svg>
                        </div>
                        <h3 class="counter_value whitespace-nowrap">
                ...
                <div class="col col-lg-3 col-md-6">
                    <div class="counter_item border-0 p-4">
                        <div class="w-20 h-20 rounded-full bg-[#FDD561] flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24"><path fill="currentColor" d="M12 20.325q-.35 0-.713-.125t-.637-.4l-1.725-1.575q-2.65-2.425-4.788-4.813T2 8.15Q2 5.8 3.575 4.225T7.5 2.65q1.325 0 2.5.562t2 1.538q.825-.975 2-1.538t2.5-.562q2.35 0 3.925 1.575T22 8.15q0 2.875-2.125 5.275T15.05 18.25l-1.7 1.55q-.275.275-.637.4t-.713.125ZM11.05 6.75q-.725-1.025-1.55-1.562t-2-.538q-1.5 0-2.5 1t-1 2.5q0 1.3.925 2.763t2.213 2.837q1.287 1.375 2.65 2.575T12 18.3q.85-.775 2.213-1.975t2.65-2.575q1.287-1.375 2.212-2.837T20 8.15q0-1.5-1-2.5t-2.5-1q-1.175 0-2 .537T12.95 6.75q-.175.25-.425.375T12 7.25q-.275 0-.525-.125t-.425-.375Zm.95 4.725Z"/></svg>
                        </div>
                        <h3 class="counter_value whitespace-nowrap">
