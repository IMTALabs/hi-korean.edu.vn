            ...
            <div class="row">
                <div class="col col-lg-8">
                    <div class="details_image">
                        <img src="assets/images/blog/blog_details_image_1.jpg" alt="Collab – Online Learning Platform">
                    </div>
                    <div class="details_content">
                        ...
                        <p>
                            Mauris rhoncus aenean vel elit scelerisque mauris. Ultrices vitae auctor eu augue ut.
                            Curabitur gravida arcu ac tortor dignissim convallis aenean et tortor. Proin fermentum leo
                            vel orci porta non pulvinar neque. At tellus at urna condimentum mattis pellentesque.
                        </p>
                        <blockquote>
                            <div class="blockquote_icon">
                                <img src="assets/images/icon/icon_quote.svg" alt="Collab – Online Learning Platform">
                            </div>
                            <div class="blockquote_content">
                                <p class="mb-0">
                                    Nec feugiat nisl pretium fusce id velit ut. Lobortis mattis aliquam faucibus purus
                                    in. Ultricies integer quis auctor elit sed. Lobortis scelerisque fermentum dui
                                    faucibus in ornare quam
                                </p>
                            </div>
                        </blockquote>
                        <p>
                            Senectus et netus et malesuada. Massa tincidunt dui ut ornare lectus sit. Sed enim ut sem
                            viverra. Fermentum odio eu feugiat pretium. Interdum varius sit amet mattis vulputate enim.
                        </p>
                        <h3 class="details_info_title">
                            Hard skills for a business analyst resume
                        </h3>
                        <p>
                            Amet cursus sit amet dictum sit amet justo. Morbi tincidunt ornare massa eget. In nulla
                            posuere sollicitudin aliquam ultrices sagittis orci a. Diam donec adipiscing tristique risus
                            nec feugiat in fermentum posuere. In mollis nunc sed id semper risus in hendrerit gravida.
                            Pretium viverra suspendisse potenti nullam ac tortor vitae purus faucibus. Aliquet lectus
                            proin nibh nisl condimentum id venenatis.
                        </p>
                        <div class="row mb-4">
                            <div class="col col-md-6">
                                <div class="details_image m-0">
                                    <img src="assets/images/blog/blog_details_image_2.jpg"
                                         alt="Collab – Online Learning Platform">
                                </div>
                            </div>
                            <div class="col col-md-6">
                                <div class="details_image m-0">
                                    <img src="assets/images/blog/blog_details_image_3.jpg"
                                         alt="Collab – Online Learning Platform">
                                </div>
                            </div>
                        </div>
                        ...
                        <p>
                            Non diam phasellus vestibulum lorem sed. Leo in vitae turpis massa sed. Urna cursus eget
                            nunc scelerisque. Elementum tempus egestas sed sed risus. Aliquam sem et tortor consequat id
                            porta nibh venenatis. Egestas congue quisque egestas diam in arcu cursus euismod.
                        </p>
                        <div class="row mb-4">
                            <div class="col col-lg-6">
                                <ul class="info_list unordered_list_block">
                                    <li>
                                        ...
                                        <span>Felis bibendum ut tristique et egestas quis ipsum</span>
                                    </li>
                                    <li>
                                        <i class="fas fa-square"></i>
                                    ...
                                    <li>
                                        <i class="fas fa-square"></i>
                                        <span>Interdum posuere lorem ipsum dolor consectetur</span>
                                    </li>
                                    <li>
                                        <i class="fas fa-square"></i>
                            ...
                            <div class="col col-lg-6">
                                <ol type="1">
                                    <li>
                                        <span>Gravida in fermentum et sollicitudin ac orci. Elit duis tristique
                                            sollicitudin nibh sit.</span>
                                    </li>
                                    <li>
                                        <span>Mauris vitae ultricies leo integer malesuada </span>
                                    </li>
                                    <li>
                        ...
                        <p class="mb-0">
                            Libero enim sed faucibus turpis in. Condimentum vitae sapien pellentesque habitant morbi
                            tristique senectus et netus. Sit amet nisl purus in mollis nunc sed id. Odio ut enim blandit
                            volutpat maecenas volutpat blandit aliquam etiam. Felis donec et odio pellentesque diam
                        ...
                        <div class="blog_author">
                            <div class="blog_author_image">
                                <img src="assets/images/blog/blog_author_image.jpg"
                                     alt="Collab – Online Learning Platform">
                            </div>
                            <div class="blog_author_content position-relative">
                                ...
                                <p class="mb-0">
                                    Vel pretium lectus quam id leo in vitae turpis. Condimentum id venenatis a
                                    condimentum vitae sapien pellentesque habitant morbi. Urna nec tincidunt praesent
                                    semper feugiat nibh sed pulvinar
                                </p>
                                <a class="btn border_dark blog_author_link" href="mentor_details.html">
                                    <span>
                                        <small>Profile</small>
                                        <small>Profile</small>
                                    </span>
