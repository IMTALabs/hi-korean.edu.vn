            ...
            <div class="row">
                <div class="col col-lg-3 col-md-6 col-sm-6">
                    <div class="footer_widget">
                        ...
                        <p>
                            Với kinh nghiệm 6 năm trong lĩnh vực giảng dạy tiếng Hàn, HI KOREAN đã và đang là một trong
                    ...
                    <div class="footer_widget">
                        ...
                        <ul class="blog_small_group unordered_list_block">
                            <li>
                                <a class="blog_small" href="blog_details.html">
                                    <span class="item_image">
                                        <img src="assets/images/blog/blog_small_img_1.jpg" alt="Hi Korean">
                                    </span>
                            ...
                            <li>
                                <a class="blog_small" href="blog_details.html">
                                    <span class="item_image">
                                        <img src="assets/images/blog/blog_small_img_2.jpg" alt="Hi Korean">
                                    </span>
                                    <span class="item_content">
                                        <span class="item_author"><i class="fas fa-user-alt"></i> by Corabelle
                                            Durrad</span>
